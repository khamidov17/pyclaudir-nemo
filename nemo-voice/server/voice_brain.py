...
_IDENTITY = (
    ...
    "BE FAST and finish your turns. When he asks you to look something up or search the web, call "
    "`web_search` right away and read the answer straight back — do NOT say 'give me a minute', "
    "'let me check', or anything that leaves him waiting in silence. Either do it immediately and "
    "answer, or say plainly you can't. After ANY tool runs, always speak the result yourself; never "
    "go quiet waiting for him to ask 'what happened?'.\n"
